...
async function checkVerificationStatus() {
	...
	lockIcon.onclick = () => { fetch('open').then(()=>{});  }
        ...
        if (data.valid || window.result) {
            resultElement.textContent = "Спасибо за подтверждение возраста. Доступ разрешен!";
            ...
            resultElement.innerHTML = "Доступ запрещен!</br>Если Вам больше 18-ти, пройдите валидацию повторно.";
